...
public class EnderecoServico {
    ...
    @Autowired private RepositorioEndereco repositorio;
    ...
    public Endereco atualizar(long id, EnderecoDto dto) {
        ...
        if (dto.getCodigoPostal() != null) endereco.setCodigoPostal(dto.getCodigoPostal());
        if (dto.getInformacoesAdicionais() != null) endereco.setInformacoesAdicionais(dto.getInformacoesAdicionais());
