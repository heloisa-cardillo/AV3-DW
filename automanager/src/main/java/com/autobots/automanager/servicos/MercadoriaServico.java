...
public class MercadoriaServico {
    ...
    public Mercadoria atualizar(long id, MercadoriaDto dto) {
        ...
        if (dto.getCadastro() != null) mercadoria.setCadastro(dto.getCadastro());
        if (dto.getQuantidade() > 0) mercadoria.setQuantidade(dto.getQuantidade());
        if (dto.getValor() > 0) mercadoria.setValor(dto.getValor());
