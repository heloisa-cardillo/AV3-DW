...
public class DocumentoServico {
    ...
    @Autowired private RepositorioDocumento repositorio;
    ...
    public Documento atualizar(long id, DocumentoDto dto) {
        ...
        if (dto.getTipo() != null) documento.setTipo(dto.getTipo());
        if (dto.getNumero() != null) documento.setNumero(dto.getNumero());
        if (dto.getDataEmissao() != null) documento.setDataEmissao(dto.getDataEmissao());
