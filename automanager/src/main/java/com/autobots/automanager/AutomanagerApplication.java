...
public class AutomanagerApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        daniele.getPerfis().add(PerfilUsuario.CLIENTE);
        ...
        credencialDaniele.setSenha("123456");
        ...
        veiculoDaniele.setTipo(TipoVeiculo.FUSCA);
        ...
        hanna.getPerfis().add(PerfilUsuario.CLIENTE);
        ...
        credencialHanna.setSenha("123456");
        ...
        veiculoHanna.setTipo(TipoVeiculo.KOMBI);
        ...
        frida.getPerfis().add(PerfilUsuario.CLIENTE);
        ...
        credencialFrida.setSenha("123456");
        ...
        veiculoFrida.setTipo(TipoVeiculo.CHEVETTE);
